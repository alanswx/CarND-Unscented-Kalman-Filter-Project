 ...
 */
UKF::UKF() {
  // start this out with false, so we will initialize our first values
...
void UKF::ProcessMeasurement(MeasurementPackage measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    // prevents nan in second run
	if (delta_t==0) return;
	
	
    //https://discussions.udacity.com/t/numerical-instability-of-the-implementation/230449/3?u=alan.steremberg
  	while (delta_t > 0.1)
  	{
